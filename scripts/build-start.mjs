...
const STEPS = [
  ...
  },
  {
    ...
    a: `Local shops around Rochester, NY with what each is good for and where you can sit down and play${shows ? `, plus ${shows} card shows coming up around Rochester, NY, Buffalo and Syracuse` : ""}. Online, the answer is a different one: what each venue costs once shipping and buyer fees are counted, and what recourse you have when a card arrives wrong.`,
    href: "/shops.html",
