    ...
    <div class="wrap">
      ...
      <div class="wtb-body">
        ...
        <p>The walk-away figure beside every gift for a collector is that product's suggested price
          ...
          reprinting them.</p>
        <!-- THIS SENTENCE USED TO SPEAK FOR THE WHOLE SITE AND CAN NO LONGER. It read "This
             site never states pull rates, because The Pokemon Company does not publish them",
             and both halves stopped being true: the owner lifted the ban on 11 September 2026
             ("you can post any pull rates or anything thats confirmed"), and
             /30th-celebration.html now prints TPCi's own published per-pack guarantees -- five
             foil cards, one foil Energy, one of the 30 Pikachu in every pack. So the page was
             making a promise another page on the same site breaks.
             THE FIX IS TO SCOPE IT TO THIS PAGE, not to delete it. The restraint is still right
             HERE and for a reason that does not depend on what anybody publishes: this page
             advises parents. /decks.html and /top-100-playable.html already word it exactly this
             way -- "this page states no pull rates" -- so this is now the third page saying the
             same page-scoped thing rather than the one page overreaching.
             The standing rule is in CLAUDE.md under "Pull rates: a SOURCING rule since 11
             September 2026, not a ban". -->
        <p>Nothing on this page says what is inside a pack or how likely anything is to be in it.
          A page giving a parent advice is the last place a probability belongs, whoever published it.</p>
