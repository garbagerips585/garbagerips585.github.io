...
function resolve(c) {
  ...
  const psa10 =
    ...
    c._psa10 ??
    null;
  // Which of them actually answered, so the stamp cannot credit the wrong one.
  const psaFromLog = psa10 != null && psa10 === c._psa10 && !manual && !auto && pcHit?.psa10 == null;
  ...
  return {
    ...
    psa10,
    psa10AsOf: manual?.asOf || auto?.asOf || (pcHit ? pc.checked : null) || (psaFromLog ? c._psa10AsOf : null) || null,
    psa10Sales: auto?.psa10Sales ?? null,
    psa10Source:
      psa10 == null ? null
      : manual || auto ? "pokemonpricetracker.com"
      : psaFromLog ? c._psa10Source || "pricecharting.com"
      : pc.source || "pricecharting.com",
    psa10Url:
      psa10 != null && !manual && !auto
        ? pcHit?.url || (psaFromLog ? c._psa10Url : null) || null
        : null,
  };
}
