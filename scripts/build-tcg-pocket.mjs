...
.tp-jump a{display:inline-flex;align-items:center;min-height:44px;padding:0 var(--s3);
...
const body = `
      ...
      <p class="lede tp-lede">Pokemon TCG Pocket is free, it is on your phone, and it is how I learned to play.
      ...
      <section class="tp-s" id="tips">
        ...
        <ol class="tp-steps">
          ...
          <li><b>Play the solo battles before you play people,</b> and watch what the computer does with its turn.
            That is the whole trick, and it is how I learned.</li>
...
<title>Pokemon TCG Pocket: Can You Learn the Real Card Game?</title>
<!-- 546px AT 20px ARIAL, AND THE OLD ONE WAS 622px AGAINST GOOGLE'S ~580px CUT.
     scripts/seo-sweep.py measured it and named this the only root page whose
     title was genuinely being truncated in search results, so the tail -- "From
     an App?" -- was the half a reader never saw.
     "FROM AN APP" WAS THE PART WORTH LOSING because the word Pocket already
     says it: this is the app. "Real" does the work that phrase was doing, which
     is to set the app against the physical TCG, and it does it in 12 characters
     instead of 13 words. The h1 still reads "Can you learn the card game from an
     app?" and that is fine: it has a whole page around it and no width limit.
     TWO SHORTER REWRITES WERE OFFERED FIRST and both changed the question --
     "Can It Teach You the Real Card Game?" at 568px and "Does It Teach the Real
     Card Game?" at 537px flip the subject from the reader to the app. This one
     keeps the h1's own question and still has 34px of headroom against the 568
     one's 12. Measured, not estimated. -->
